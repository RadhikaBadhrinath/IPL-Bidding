...
select a.BIDDER_ID,a.BIDDER_NAME,truncate((sum(case when b.BID_STATUS ='Won' then 1 else 0 end)/count(*))*100,2) as win_percent
...
join ipl_team b
on a.TEAM_ID=b.TEAM_ID
where player_role= 'All-Rounder' group by 1,3 having count(*)>4;
